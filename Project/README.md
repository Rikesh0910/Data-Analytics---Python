...
visit my notebook with detailed steps here!
...
View my notebook with detailed steps here: [Skills_trend.ipynb](Skills_trend.ipynb)
...
### Results
![Visualization of trending top skills for data analysts in US](images\output2.png)
...
```
### Results
![Visualization of salary distribution of data jobs in US](images\output3.png)
...
```
### Results
![visualization of highest paid and demanded skills for data analysts in the US](images\output4.png)
...
```
### Results
![Visualization of the most optimal skills to learn for data analysts](images\output5.png)
